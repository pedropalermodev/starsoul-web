    ...
    return(
        <>
            <Container className='home__container'>
                <Content className='home__container-hero'>
                    <div className="home__container-hero-description">
                        <h1 className="home__container-hero-description--h1">
                            A StarSoul é um aplicativo dedicado ao autocuidado e bem-estar, oferecendo 
                            conteúdos exclusivos como vídeos relaxantes, meditações guiadas e músicas 
                            tranquilizantes. Baixe o app para se conectar consigo mesmo e iniciar sua 
                            jornada rumo a uma vida mais saudável e equilibrada. Junte-se a nós e comece hoje!
                        </h1>
                        <h2 className="home__container-hero-description--h2">StarSoul</h2>
                        <Button text={'Aprenda sobre a Meditação'} to="/about-meditation" />
                    </div>
                    <div className="home__container-hero-phone">
                        <img src={Phone} alt="StarSoul" />
                    </div>
                </Content>
            </Container>
            ...
            <Container className='home__container'>
                <Content className='home__container-section'>
                    ...
                    <div className="home__container-section-description">
                        ...
                        <Button text={'Aprenda a baixar nosso aplicativo'} to="/about-meditation"/>
                    </div>
                </Content>
            </Container>
